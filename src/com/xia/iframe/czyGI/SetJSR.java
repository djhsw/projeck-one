package com.xia.iframe.czyGI;

import com.xia.dao.Dao;
import com.xia.iframe.JsrGL;
...
public class SetJSR extends JPanel {//设置经手人面板
    ...
    public SetJSR(){//设置经手人面板
        ...
        setBounds(0,0,491,200);//设置“经手人面板”的位置和宽高
        setLayout(new GridBagLayout());//设置“经手人面板”的布局为网格布局
        ...
        gridBagConstraints.insets = new Insets(0,0,20,0);//组件彼此之间的间距
        gridBagConstraints.gridheight = 12;//组件横向跨越12个网格
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(final MouseEvent e) {
                ...
                nameStr = table.getValueAt(selRow,1).toString().trim();//获取“姓名”
                ageStr = table.getValueAt(selRow,3).toString().trim();//获取“年龄”
                sexStr = table.getValueAt(selRow,2).toString().trim();//获取“性别”
        ...
        nameField = new JTextField();//设置“姓名”文本框不可编译
        final GridBagConstraints gridBagConstraints_4 = new GridBagConstraints();//创建网格限制对象
        gridBagConstraints_4.insets = new Insets(0,0,0,10);//组件彼此之间的距离
        gridBagConstraints_4.fill = GridBagConstraints.HORIZONTAL;//组件水平夸大以占据空白区域
