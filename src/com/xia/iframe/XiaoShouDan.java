...
import com.xia.dao.model.*;

public class XiaoShouDan extends JInternalFrame {//销售单内部窗口
    ...
    public XiaoShouDan() {// 销售单内部窗体的构造方法
        ...
        kehu.addActionListener(new ActionListener() {// 为“客户”下拉列表添加选择时间的监听
        ...
        // “商品”下拉列表
        sp = new JComboBox();
        sp.addActionListener(new ActionListener() {// 为“商品”下拉列表添加动作事件的监听
            public void actionPerformed(ActionEvent e) {
        ...
        sellButton.addActionListener(new ActionListener() {// 为“销售”按钮添加动作事件的监听
            public void actionPerformed(ActionEvent e) {
    ...
    private void initSpBox() {
        ...
        ResultSet set = Dao.query("select * from tb_spinfo where id in (select id from tb_kucun where kcsl>0)");// 获得库存数量大于0的商品信息的结果集
    ...
    private synchronized void clearEmptyRow() {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            if (info2 == null || info2.getId() == null || info2.getId().isEmpty()) {// 商品信息为空
