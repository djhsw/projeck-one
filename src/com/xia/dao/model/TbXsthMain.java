...
public class TbXsthMain implements Serializable {//销售退货主表
    ...
    public TbXsthMain(String xsthId, String pzs, String je, String ysjl, String khname, String thdate, String czy, String jsr, String jsfs) {
        this.xsthId = xsthId;
        this.pzs = pzs;
        this.je = je;
        this.ysjl = ysjl;
