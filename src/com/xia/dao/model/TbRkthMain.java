...
public class TbRkthMain implements Serializable {//进货退货主表
    ...
    public TbRkthMain(String rkthId, String pzs, String je, String ysjl, String gysname, String rtdate, String czy, String jsr, String jsfs) {
        this.rkthId = rkthId;
        this.pzs = pzs;
        this.je = je;
        this.ysjl = ysjl;
